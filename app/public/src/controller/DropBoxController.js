class DropBoxController {
    ...
    connectFirebase(){
      ...
      // Your web app's Firebase configuration
        var firebaseConfig = {
        apiKey: "AIzaSyD5IOshTrLVFeHWQqItNGvpsUSOrJAeIco",
        authDomain: "dropbox-clone-2d2c6.firebaseapp.com",
        databaseURL: "https://dropbox-clone-2d2c6-default-rtdb.firebaseio.com",
        projectId: "dropbox-clone-2d2c6",
        storageBucket: "dropbox-clone-2d2c6.appspot.com",
        messagingSenderId: "490702824595",
        appId: "1:490702824595:web:df87c08690e20837195966"
      };
      // Initialize Firebase
    ...
    getFirebaseRef(path){
        ...
        let fireb = firebase.database().ref(path) 
    ...
    uploadProgress(event, file){
        ...
        //console.log(`Tempo gasto: ${timespent}, Porcentagem: ${porcent}%, Tempo restante: ${timeleft}`)
